  ...
  def update
    respond_to do |format|
      if @surgery_recipe_req.update(surgery_recipe_req_params)
        # notice: 'Surgery recipe req was successfully updated.'
        format.html {redirect_to root_path, notice: 'Surgery recipe req was successfully updated.' }

        # render partial: 'layouts/side_bar'
        # redirect_to @surgery_recipe_req
        # format.js
        # format.json { render :show, status: :ok, location: @surgery_recipe_req }
      else
        # notice: 'Surgery recipe req was NOT successfully updated.'
        format.html { render :edit, notice: 'Surgery recipe req was NOT successfully updated.' }
        # format.json { render json: @surgery_recipe_req.errors, status: :unprocessable_entity }
      end
    end
  end
